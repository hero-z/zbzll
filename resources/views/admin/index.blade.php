...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <a href="{{url('admin/billquery')}}"class="label label-success pull-right" target='_self'>查看详情</a>
                    <h5>累计收款</h5>
                </div>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <a href="{{url('admin/billquery')}}"class="label label-primary pull-right" target='_self'>查看详情</a>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <a href="{{url('admin/billquery')}}"class="label label-warning pull-right" target='_self'>查看详情</a>
                    <h5>日收款</h5>
                </div>
                <div class="ibox-content">
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="stat-percent font-bold text-danger col-sm-6" id="update">

                    </div>
                    <div class="stat-percent font-bold  col-sm-6">
                        <button type="button" class="btn btn-outline btn-default" >版本号:{{$data->app_version}}</button>
                    </div>
                    <ul>
                        <li>{{$data->msg}}</li>
                    </ul>
...
<script>
    $(document).ready(function(){
        ...
        var dataset=[{
            ...
            data:data3,
            color:"#1ab394",
            bars:{show:true,align:"center",barWidth:24*60*60*600*20,lineWidth:0
            }},
            {
                label:"已缴金额",
                data:data2,
...
<script>
    ...
    function get() {
        ...
        $.post("{{route('updateInfo')}}", {_token: "{{csrf_token()}}"},
            function (data) {
                root="{{Auth::guard('admin')->user()->hasRole('root')}}";
                if (data.status == 1) {
                    if(root){
                        $("#update").append('<button type="button" class="btn btn-outline btn-primary"  onclick="updateFile()">更新系统</button>');
                    }
