...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            ...
            <!-- Start Sign In Form -->
            <form class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="POST" action="{{ route('admin.login') }}">
                <h2>登录</h2>
                 {{ csrf_field() }}
                ...
                <div class="form-group">
                    <label for="remember"> <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> 记住我</label>
                </div>
                <div class="form-group">
                    <p>? 没有注册<a href="sign-up3.html">注册</a> | <a href="forgot3.html">忘记密码?</a></p>
                </div>
                <div class="form-group">
