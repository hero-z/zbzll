...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            ...
            <!-- Start Sign In Form -->
            <form class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="POST" action="{{ route('merchant.login') }}">
                <h2>登录</h2>
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <label for="remember"> <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> <p>记住我| <a href="">忘记密码?</a>|没有账号? <a href="{{route('register')}}">注册</a> </p></label>
                </div>
                <div class="form-group">
